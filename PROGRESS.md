...
- **Superseded:** the Phase 0 "open seat: user-owned cross-vendor context layer" verdict (2026-06-11 scoreboard) was falsified by the 2026-06-17 market re-check — the cross-vendor/user-owned ideas are now contested; positioning must lead with local-first custody + source-available (see [docs/VISION.md](./docs/VISION.md)). PIVOT.md competitive framing still needs a refresh.
