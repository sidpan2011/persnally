    ...
    <div className="relative min-h-screen bg-night text-ink flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="border-glow rounded-2xl border border-line bg-surface p-8 text-center shadow-[0_0_60px_-20px_var(--color-electric)]">
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-volt mb-5">
            Context engine
          </p>
          ...
          {error && (
            <div className="rounded-lg border border-volt/30 bg-panel p-3 mb-6 text-sm text-[#ff7a7a]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg bg-electric px-6 py-3 text-sm font-medium text-white shadow-[0_0_28px_-6px_var(--color-electric)] transition-colors hover:bg-volt cursor-pointer"
          >
